...
const HomeSection = () => {
  ...
  return (
    <div className='container mx-auto p-4 flex lg:flex-row flex-col items-center mt-5 gap-5 justify-center'>
      <div className='flex lg:flex-col sm:flex-row flex-col bg-[#4080e0] rounded-[10px] xl:pt-10 xl:pb-[30px] pt-8 pb-6 sm:px-8 px-6 text-white'>
      ...
      <div className='flex lg:flex-col sm:flex-row flex-col bg-[#FFD40C] rounded-[10px] xl:pt-10 xl:pb-[30px] pt-8 pb-6 sm:px-8 px-6 text-gray-800 h-full' style={{ backgroundImage: 'linear-gradient(180deg, #F197CA 50%, #ECF2CF 50%)' }}>
        <div className='flex flex-col'>
      ...
      <div className='flex lg:flex-col sm:flex-row flex-col bg-[#E12E2E] rounded-[10px] xl:pt-10 xl:pb-[30px] pt-8 pb-6 sm:px-8 px-6 text-white h-full'>
        <div className='flex flex-col'>
