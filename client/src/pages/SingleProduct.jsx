        ...
        <div className="container mx-auto px-4 mt-10">
            <div className="flex flex-col md:flex-row gap-16">
                <div className="flex gap-3">
                    ...
                    <div className="border border-gray-500/30 max-w-100 rounded overflow-hidden bg-gray-50">
                        <img src={JSON.parse(product?.image)} alt="Selected product" className="min-w-[530px] h-full object-cover" />
                    </div>
                </div>

                <div className="w-full md:w-1/2">
                    <p className="text-gray-800/90 font-medium text-base">
                        <span>Home</span> /
                        <span> Products</span> /
                        <span> {product.category}</span> /
                        <span className="text-[#994CF5]"> {product.name}</span>
                    </p>
                    <p className="text-4xl font-semibold mt-5 mb-2 text-gray-800">{product.name}</p>
                    ...
                    <div className="mt-5 flex items-center gap-3">
                        <p className="text-gray-500/70 text-2xl font-medium line-through">{currency}{product.price}.00</p>
                        <p className="text-2xl font-medium text-[#E12E2E] underline">{currency}{product.offerPrice}.00</p>
                    </div>
                    ...
                    <div className="flex items-center mt-8 gap-4 text-base">
                        ...
                        <button className="w-full py-3.5 cursor-pointer font-medium bg-[#994CF5] text-white hover:bg-gray-800 transition" >
                            Buy now
                        </button>
                    </div>
                </div>
            ...
            <div className="mt-10">
                <div className="flex">
                    <div className="border px-8 py-3 cursor-pointer text-gray-800 text-sm">Description</div>
                    {/* <div className="border px-5 py-3 cursor-pointer">Review (122)</div> */}
                </div>
                <p className="flex flex-col gap-4 border px-6 py-6 text-gray-800/80 text-sm" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(product?.description) }}>
                </p>
            </div>
